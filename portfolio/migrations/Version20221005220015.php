 ...
 */
final class Version20221005220015 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE post_old_slug (id INT AUTO_INCREMENT NOT NULL, post_id INT DEFAULT NULL, old_slug VARCHAR(255) NOT NULL, INDEX IDX_FED93664B89032C (post_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE post_old_slug DROP FOREIGN KEY FK_FED93664B89032C');
